...
column_calculator_drag.appendChild(DOM_create_div_drag('div_drag_calculator',`div_calculator_drag_${modifier_nbr_new}`,'calculator',"img/drag.jpg"))
column_calculator_drag.appendChild(DOM_create_div_drag('div_drag_right_calculator',`div_calculator_drag_after_${modifier_nbr_new}`,'calculator',"img/right.png"))
