function loading_page_importing() {
    ...
    document.getElementById('button_download_diagCalc_ready_import_XML').addEventListener('click', function () { get_array_download_diag_calc_ready(ready_import_id_array) })
