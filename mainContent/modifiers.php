        ...
        <tr>
          ...
          <td>
            <form name="form" action="download/download_modifier_XML.php" method="POST">
              ...
              <input type="submit" name="button1" class="button_download" id="button_download_modifier_XML_submit" value="Download as XML" style="display:none"/>
            </form>
            <p>
            ...
            <form name="form" action="download/download_modifier_TXT.php" method="POST">
              ...
              <input type="submit" name="button2" class="button_download" id="button_download_modifier_TXT_submit" value="Download as TXT" style="display:none"/>
            </form>
          </td>
          <td>
            <form name="form" action="download/download_sub_modifier_XML.php" method="POST">
              ...
              <input type="submit" name="button1" class="button_download" id="button_download_sub_modifier_XML_submit" value="Download as XML" style="display:none"/>
            </form>
            <p>
            ...
            <form name="form" action="download/download_sub_modifier_TXT.php" method="POST">
              ...
              <input type="submit" name="button2" class="button_download" id="button_download__sub_modifier_TXT_submit" value="Download as TXT" style="display:none"/>
            </form>
          </td>
        </tr>
      </table>