    ...
    <td>
      <table>
        ...
        <td>
          ...
          <td>
          <input type="button" id="button_soft_delete" class="button_download" value="Soft deletes">
    ...
    <td>
      <table id="table_input">
        <tr id="tr_calculator_drag">
          ...
          <div id="div_calculator_drag_after_1" class="div_drag_right_calculator"></div>
</td>
</tr>
      ...
      <table>
        <tr id="tr_calculator_button_checkbox">
          ...
          <td>
          Reviewed by Coding:<input type ="checkbox" name="checkbox_reviewed_coding" id="checkbox_reviewed_coding" form="form_saveMongoDB" class="input_readonly" value="true"></br>
          ...
          <input type="hidden" name="checkbox_reviewed_coding_changed" id="checkbox_reviewed_coding_changed" value="false" form="form_saveMongoDB">
</td>
          <td>
          Reviewed by SME:<input type ="checkbox" name="checkbox_reviewed_SME" id="checkbox_reviewed_SME" form="form_saveMongoDB" class="input_readonly" value="true"></br>
          ...
          <input type="hidden" name="checkbox_reviewed_SME_changed" id="checkbox_reviewed_SME_changed" value="false" form="form_saveMongoDB">   
        </td>
          <td>
          Ready to import:<input type ="checkbox" name="checkbox_ready_import" id="checkbox_ready_import" form="form_saveMongoDB" class="input_readonly" value="true"></br>
          ...
          <input type="hidden" name="checkbox_ready_import_changed" id="checkbox_ready_import_changed" value="false" form="form_saveMongoDB">
          </td>
          <td>
          Imported:<input type ="checkbox" name="checkbox_imported" id="checkbox_imported" form="form_saveMongoDB" class="input_readonly" value="true"></br>
          ...
          <input type="hidden" name="checkbox_imported_changed" id="checkbox_imported_changed" value="false" form="form_saveMongoDB">
          </td>
        </tr>
      </table>
    </td>
