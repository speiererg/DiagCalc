    ...
    <td>
      ...
      <table>
        <tr>
          ...
          <input type="text" name="input_reviewed_coding_last" id="input_reviewed_coding_last"form="form_saveMongoDB"></br>
          <input type="text" name="input_reviewed_coding_changed_since" id="input_reviewed_coding_changed_since"form="form_saveMongoDB"> 
          ...
          <input type="text" name="input_reviewed_SME_last" id="input_reviewed_SME_last"form="form_saveMongoDB"></br>
          <input type="text" name="input_reviewed_SME_changed_since" id="input_reviewed_SME_changed_since"form="form_saveMongoDB"> 
          ...
          <input type="text" name="input_ready_import_last" id="input_ready_import_last"form="form_saveMongoDB"></br>
          <input type="text" name="input_ready_import_changed_since" id="input_ready_import_changed_since"form="form_saveMongoDB"> 
          ...
          <input type="text" name="input_imported_last" id="input_imported_last"form="form_saveMongoDB"></br>
          <input type="text" name="input_imported_changed_since" id="input_imported_changed_since"form="form_saveMongoDB"> 
