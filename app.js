...
function importing_calculator(results_findOne) {
    ...
    document.getElementById('select_version').addEventListener('change',(event)=>{console.log(event);changePage(`calculator`, `calculator_id=${results_findOne['calculator_id']}&version=${document.getElementById('select_version').value}`,'')})
