...
function importing_calculator(results_findOne) {
    ...
    let params_link = 
    document.getElementById('select_version').addEventListener('change',(event)=>{changePage(`calculator`, `calculator_id=${results_findOne['calculator_id']}&version=${event.value}`,'')})
