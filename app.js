...
function importing_calculator(results_findOne) {
    ...
    for (i = 1; i <= results_findOne['modifier_nbr']; i++) {
        document.getElementById(`td_input_modifier_id_1${i}`).innerHTML = `Modifier Id: ${modifiers_array[i - 1]['modifier_id']}`
        document.getElementById(`input_modifier_id_1${i}`).value = modifiers_array[i - 1]['modifier_id']
