...
function importing_calculator(results_findOne) {
    ...
    document.getElementById('select_version').addEventListener('change',(event)=>{console.log(`calculator_id=${results_findOne['calculator_id']}&version=${event.value}`);changePage(`calculator`, `calculator_id=${results_findOne['calculator_id']}&version=${event.value}`,'')})
