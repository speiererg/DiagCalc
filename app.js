...
function addInputColumn(params) {
    ...
    if (params[`radio_input`] == modifier_nbr + 1) { 
        document.getElementById(`radio_input_${modifier_nbr + 1}`).checked = true 
        click_radio_input(document.getElementById(`radio_input_${modifier_nbr + 1}`))}
